...
func (_m *Normalizer) Denormalize(spec v1.Spec) map[string]string {
	ret := _m.Called(spec)

	var r0 map[string]string
	if rf, ok := ret.Get(0).(func(v1.Spec) map[string]string); ok {
		r0 = rf(spec)
	} else {
		if ret.Get(0) != nil {
...
func (_m *Normalizer) Normalize(env map[string]string) v1.Spec {
	ret := _m.Called(env)

	var r0 v1.Spec
	if rf, ok := ret.Get(0).(func(map[string]string) v1.Spec); ok {
		r0 = rf(env)
	} else {
		r0 = ret.Get(0).(v1.Spec)
	}
